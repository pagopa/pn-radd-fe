...
>(
  'startInquiry',
  async (params: DocumentInquiryFormAction, { rejectWithValue, getState, dispatch }) => {
    try {
...
export const uploadFile = createAppAsyncThunk<void, UploadFileAndStartTransactionArgs>(
  'uploadFile',
