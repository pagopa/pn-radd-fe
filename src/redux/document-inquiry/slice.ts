...
import { DocumentInquiryFile, DocumentInquiryForm, DocumentInquiryRequest, DocumentInquiryTransaction } from './types'
...
export const operationIdSelector = (state: RootState) => state.documentInquiry.transactionData.operationId;
