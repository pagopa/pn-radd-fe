...
describe("NotificationInquiryConverter", () => {
    it("operationsActDetailsToOperationsResponse", () => {
        ...
        const converted = NotificationInquiryConverter.operationsActDetailsToOperationsResponse(response);
    ...
    it("operationsAorDetailsToOperationsResponse", () => {
        ...
        const converted = NotificationInquiryConverter.operationsAorDetailsToOperationsResponse(response);
        expect(converted.result).toStrictEqual(response.result);
        expect(converted.status).toStrictEqual(response.status);
    ...
    it("operationActResponseToOperationsResponse", () => {
        ...
        const converted = NotificationInquiryConverter.operationActResponseToOperationsResponse(response);
        expect(converted.result).toStrictEqual(response.result);
        expect(converted.status).toStrictEqual(response.status);
        expect(converted.operations).toStrictEqual([
            {
    ...
    it("operationAorResponseToOperationsResponse", () => {
        ...
        const converted = NotificationInquiryConverter.operationAorResponseToOperationsResponse(response);
        expect(converted.result).toStrictEqual(response.result);
        expect(converted.status).toStrictEqual(response.status);
