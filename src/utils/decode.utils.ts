...
export const decodeInquiryType = (code: string) => {
  switch (code) {
    case DocumentInquiryType.ACT:
      return 'Documenti allegati e attestazioni opponibili a terzi';
    case DocumentInquiryType.AOR:
      return 'Avvisi di avvenuta ricezione';
    default:
      return '';
  }
};
...
export const decodeSearchType = (code: string) => {
  switch (code) {
    case SearchType.IUN:
      return 'IUN';
    case SearchType.OPERATION_ID:
      return 'ID Operazione';
    case SearchType.TAX_ID:
