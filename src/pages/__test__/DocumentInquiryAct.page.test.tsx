...
import DocumentInquiryAct from '../DocumentInquiryAct.page';
...
describe('DocumentInquiryAct page', () => {
  let result: RenderResult;

  beforeEach(() => {
    result = render(<DocumentInquiryAct />);
  });
  ...
  it('should render first step', () => {
    ...
    expect(pageTitle).toHaveTextContent('Documenti allegati e attestazioni opponibili a terzi');
